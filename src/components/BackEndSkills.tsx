import { FaPhp, FaLaravel, FaJava } from "react-icons/fa";

const BackEndSkills = () => {
  return (
    <>
          <i className="flex justify-center items-center hover:text-primary" title="Laravel">
        <FaLaravel />
      </i>
      <i className="flex justify-center items-center hover:text-primary" title="PHP">
        <FaPhp />
      </i>
      <i className="flex justify-center items-center hover:text-primary" title="Java">
        <FaJava />
      </i>

      {/* <i className="flex justify-center items-center hover:text-primary" title="Go">
        <svg role="img"  width={"55px"} className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <title>Go</title>
